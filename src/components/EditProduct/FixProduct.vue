        ...
        <div class="modal-body">
          <form>
            ...
            <div class="mb-3">
              ...
              >
                <option value="Tide">Apple</option>
                <option value="Gain">SamSung</option>
                <option value="Persil">Xiaomi</option>
                <option value="Persil">Oppo</option>
              </select>
            </div>
            <div class="mb-3">
