          ...
          <div class="preview col-md-6">
            <div class="preview-pic tab-content">
              <div class="tab-pane active" id="pic-1">
                <img
                  src="https://cdn.tgdd.vn/Products/Images/42/251192/s16/iphone-14-pro-max-purple-650x650.png"
                />
              </div>
            </div>
          </div>
          <div class="details col-md-6">
            <h3 class="product-title">iphone 14 pro max (chính hãng VN/A)</h3>
            <div class="rating">
            ...
            <p class="product-description">
              iPhone 14 Pro Max có sự cải tiến lớn về màn hình so với iPhone 13
              Pro Max. Sự khác biệt giữa phiên bản iPhone 14 Pro Max 256GB và
              phiên bản tiêu chuẩn 128GB.
            </p>
            <h4 class="price">
              Giá: <span>18.000.000 <sup>vnd</sup></span>
            </h4>
